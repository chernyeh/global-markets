...
- ${MARKET_CONCERN_NOTE}
- Source hierarchy: Bloomberg, WSJ, FT, Reuters (incl. Breakingviews), SCMP, NYT, Washington Post, Semafor, the Guardian, and Globe and Mail take precedence over regional or niche publications when covering the same event. The exception is Taiwan's business press — the Commercial Times (工商時報 / CTEE), Economic Daily News (經濟日報 / UDN Money), Liberty Times (自由時報 / 自由財經) and Wantrich (旺得富): on the semiconductor and electronics supply chain, trade policy and cross-strait geopolitics they are primary sources, not regional echoes — lead with them on those stories and cite them directly.
